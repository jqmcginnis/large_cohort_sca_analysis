#!/bin/bash
#
# T2w CPU phase: label parsing, registration, CSA, aSCOR, SPINEPS CSA, QC.
#
# This is the CPU half of the split pipeline. It expects GPU outputs to already
# exist in the subject directory (from process_csa_t2w_gpu.sh).
#
...
#   sct_run_batch -script process_csa_t2w_cpu.sh \
